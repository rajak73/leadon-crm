...
const en: Dict = {
  ...
  'nav.autoReplyRules': 'Auto Reply Rules',
  'nav.team': 'Team',
  'nav.billing': 'Billing',
  ...
  'leads.emptyAction': 'Add your first lead',
  'leads.score': 'Score',
...
const hi: Dict = {
  ...
  'nav.autoReplyRules': 'ऑटो रिप्लाई नियम',
  'nav.team': 'टीम',
  'nav.billing': 'बिलिंग',
  ...
  'leads.emptyAction': 'अपनी पहली लीड जोड़ें',
  'leads.score': 'स्कोर',
...
const es: Dict = {
  ...
  'nav.autoReplyRules': 'Reglas de respuesta automática',
  'nav.team': 'Equipo',
  ...
  'leads.emptyAction': 'Añade tu primer prospecto',
